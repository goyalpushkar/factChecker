...
class CaptionDerivationVideo:
    ...
    def __init__(self, kwargs=None):
        ...
        self.db = Database()
        self.authorization = Authorization(kwargs={"properties":self.properties})
    ...
    def get_captions_google(self, video_path, language_code="en"):
        ...
        try:
            ...
            logging.info(f"get_captions_google: Getting captions from: {list_url}")
            response = authed_session.get(list_url)
            logging.info(f"get_captions_google: Getting captions response: {response}")
