...
from utils import Utils, TokenizationType, AvailableModels, ReturnTensorTypes, AvailableLanguages, TextToAudioSources, SpeechSynthesizers, AvailableCountryCodes
...
class TextToAudio:
    ...
    def get_file_name(self, text, model_name, extension="mp3"):
        ...
        folder_name = self.properties.get_property("folders", "audio_folder")
    ...
    def get_file_without_folder_name(self, file_name, target_dir="audioFiles"):
        """
        Get the file name for the audio file
        """
        # to send path from target_dir=audioFiles folder onwards
